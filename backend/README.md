...
## Project Structure
    ...
    ├── vigilanceai_test_38017  # Django project configurations
...
1. Clone this repo and `cd vigilanceai_test_38017`
...
2. Clone this repo and `cd vigilanceai_test_38017`
